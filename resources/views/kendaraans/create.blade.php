                                ...
                                <form action="{{ route('kendaraans.store') }}" method="POST" enctype="multipart/form-data" >
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nomor_polisi"  value="{{ old("nomor_polisi") }}" >
                                        ...
                                        <div class="form-group">
                                            <label>Tahun</label>
                                            <input type="text" id="yearpicker" class="form-control" name="tahun"  value="{{ old("tahun") }}" >
                                            @if ($errors->has('tahun'))
                                        ...
                                        <div class="form-group">
                                            <label>Foto</label>
                                            <input type="file" class="dropify" name="foto_kendaraan"  value="{{ old("foto_kendaraan") }}" >
